...
- Since Signposting requires machine interactions with scholarly platforms, COAR Notify discourages the use of content delivery network services, blocking robotic access, or requiring CAPTCHA tests to access scholarly objects. 
